...
public EmbeddedSource getEmbeddedSource() {
	return embeddedSource;
}
public void setEmbeddedSource(EmbeddedSource embeddedSource) {
	this.embeddedSource = embeddedSource;
}
public static Logger getLogger() {
	return LOGGER;
}
public MaterializedConfigurationProvider getConfigurationProvider() {
	return configurationProvider;
}
public String getName() {
	return name;
}
public LifecycleSupervisor getSupervisor() {
	return supervisor;
}
